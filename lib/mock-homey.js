...
Homey.manager = function (arg) {
    ...
    case 'api':
        return {
            realtime: function (functionName, object) {
                for (var event in Homey._events) {
                    if (Homey._events[event].name == functionName) {
                        Homey._events[event](object);
                    }
                }
            }
        };
