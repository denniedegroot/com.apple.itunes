...
function open_session() {
    daap.serverInfo(function (error, response) {
        ...
        if ('dmap.serverinforesponse' in response &&
            'dmap.timeoutinterval' in response['dmap.serverinforesponse']) {
            daap.timeout = response['dmap.serverinforesponse']['dmap.timeoutinterval'] * 1000;
        }
